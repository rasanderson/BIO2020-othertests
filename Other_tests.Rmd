...
To get a better understanding of ranked data, play with the following code, changing the values of the data used in `my_tiny_dat`. There is not a built-in R function for signed-ranks, but we can easily create one as shown on the first line.
